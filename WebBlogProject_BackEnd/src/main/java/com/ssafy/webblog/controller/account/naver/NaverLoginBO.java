...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "LwH6DZMYh297nQGCkkUi";
	private final static String CLIENT_SECRET = "XJ3rMnBnbs";
	...
	public String getAuthorizationUrl(HttpSession session) {
		String REDIRECT_URI = "http://"+backurl+"/account/naverlogin/callback";
